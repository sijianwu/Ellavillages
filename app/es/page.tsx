        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex space-x-6">
              <a href="/es" className="text-gray-900 font-medium border-b-2 border-gray-900">Inicio</a>
              ...
              <div className="ml-4">
                <a href="/en" className="text-sm bg-gray-100 px-3 py-1 rounded-full hover:bg-gray-200">🇺🇸 EN</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                Descubre <span className="text-green-600 italic">Vida Acogedora</span><br/>
                Con Alquiler Razonable
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                Condominios modernos y acogedores en vecindarios seguros. Tu hogar perfecto te espera en Houston, Texas.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
              Donde la Comodidad Se Encuentra con la Conveniencia
            </h2>
            <p className="text-lg text-gray-600 leading-relaxed">
              Descubre la combinación perfecta de comodidad y conveniencia en nuestras unidades de condominios inteligentes y acogedoras cuidadosamente diseñadas. 
              Ideal para solteros, parejas o profesionales que buscan una solución de vivienda que se sienta como hogar desde el momento en que entras.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white p-8 rounded-2xl text-center shadow-lg hover:shadow-xl transition-shadow">
              <p className="text-sm uppercase mb-2 opacity-90">Disponible</p>
              <h3 className="text-4xl font-bold mb-1">$1,600</h3>
              <p className="text-lg mb-2">/ Mes</p>
              <p className="text-sm opacity-80 mb-4">Unidad A/B/C/D</p>
              <div className="space-y-2 mb-6 text-sm opacity-90">
                <p>Depósito de seguridad no incluido</p>
                <p>Servicios públicos no incluidos</p>
              </div>
            ...
            <div className="bg-gradient-to-r from-purple-500 to-pink-600 text-white p-8 rounded-2xl text-center shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-lg mb-2">/ Mes</p>
              <p className="text-sm opacity-80 mb-4">Unidad E/F</p>
              <div className="space-y-2 mb-6 text-sm opacity-90">
                <p>Depósito de seguridad no incluido</p>
                <p>Servicios públicos no incluidos</p>
              </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Comunidad</h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: '🏠', title: 'Moderno', desc: 'Uso inteligente del espacio con diseños modernos' },
              { icon: '🔇', title: 'Tranquilo', desc: 'Vecindario tranquilo y seguro' },
              { icon: '📍', title: 'Conveniente', desc: 'Cerca de tiendas, cafés y transporte público' },
              { icon: '📅', title: 'Largo plazo', desc: 'Ideal para estancias de largo plazo' }
            ].map((feature, index) => (
              <div key={index} className="text-center">
                <div className="aspect-square bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl flex items-center justify-center mb-6">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600">Espacio {feature.title}</p>
                  </div>
                </div>
      ...
      <footer className="bg-black text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-md mx-auto">
            Condominios modernos y acogedores en vecindarios seguros con alquiler razonable. Tu hogar perfecto te espera.
          </p>
          <div className="flex justify-center space-x-8 text-sm mb-8">
            <a href="/es" className="hover:text-white transition-colors">Inicio</a>
            <a href="/es/about" className="hover:text-white transition-colors">Acerca de</a>
            <a href="/es/properties" className="hover:text-white transition-colors">Propiedades</a>
            <a href="/es/contact" className="hover:text-white transition-colors">Contacto</a>
          </div>
          <div className="text-gray-500 text-sm">
            <p>© 2024 Ellavillages. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
